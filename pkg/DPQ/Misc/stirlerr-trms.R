...
24*(BZ(257875)/248832 - Rmpfr::zeta(5))
...
str(x <- lseq(2^-70, 2^-10, length=1000))
...
## == N(1/BZ(688128) + 720*(N(BZ(36130315)/35831808) - Rmpfr::zeta(7))/5040) ## as 720/5040 == 1/7 :
## == 1/BZ(688128) +         ( BZ(36130315)/35831808 - Rmpfr::zeta(7))/7
## == (1/BZ(688128) + BZ(36130315)/35831808 / 7) - Rmpfr::zeta(7)/7
## == mpfr( BZ(72261359)/BZ(501645312), precBits = 256) - Rmpfr::zeta(mpfr(7, 256))/7 
mpfr( BZ(72261359)/BZ(501645312), precBits = 256) - Rmpfr::zeta(mpfr(7, 256))/7 

## z4.9:
psigamma(5, deriv=8) #  -0.02612193
psigamma(5, 8) / 362880 #  -7.198504e-08
## FunctionExpand[PolyGamma[8, 5]]
'40320 (5170139875/5159780352 - ζ(9))' #-0.026121932577157847256668711028032780542422983569899521811529705...
40320/ 362880 *(mpfr(BZ(5170139875)/5159780352, 256) - Rmpfr::zeta(mpfr(9, 256))) #
(mpfr(BZ(5170139875)/BZ(5159780352)/9, 256) - Rmpfr::zeta(mpfr(9, 256))/9) #
...
c4.7 <- asNumeric(mpfr( BZ(72261359)/BZ(501645312), precBits = 256) - Rmpfr::zeta(mpfr(7, 256))/7)  # (1/688128 + psigamma(5, 6)/5040)
c4.8 <- asNumeric(Pi^8/75600 - BZ(6044274287)/48157949952) # π^8/75600 - 6044274287/48157949952
##      asNumeric(40320*(BZ(5170139875)/5159780352 - Rmpfr::zeta(9)) / 362880) 
c4.9 <- asNumeric((mpfr(BZ(5170139875)/BZ(46438023168), 256) - Rmpfr::zeta(mpfr(9, 256))/9)) # psigamma(5, 8) / 362880
...
abline(v=2^p2, col="lightblue", lty=2)
axis(1, at=2^p2, labels=as.expression(lapply(p2+0, \(n) substitute(2^N, list(N=n)))), lwd=NA, line=-2)
axis(1, at=0.07, col.axis="blue", lwd=NA, line=-0.8, cex=2/3)
abline(  v=0.07, col="blue", lty=3)
## ===> f0() covers for all z = n <= 0.03 (w/ O(z^{10})) and 0.07 (w/ O(z^{13})   .... but that's were the direct formula is ok, too !!!!
##      ~~~~                ~~~~~~~~~~~~~                    ====
